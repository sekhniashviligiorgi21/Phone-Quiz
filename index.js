...
document.getElementById("next").addEventListener("click", function () {
    ...
    img.src = "/Lego bricks/iphone14.png";
    img.width = 200;
});
...
//---------------------------------correct,wrong,wrong------------------------------        
        ...
        document.getElementById("wrong3").addEventListener("click",function(){
            ...
            img.src=("/Lego bricks/hmdskyline.png")
            ...
            document.getElementById("submit").onclick=function(){
                ...
                if (A=="hmd skyline"){
                    ...
                    document.getElementById("I").style.display="none"
                    document.getElementById("submit").style.display="none"
                    img.src=("/Lego bricks/congratulations.webp")
                }
                else
...
//-------------------------------correct,wrong,correct---------------------------------
        ...
        img.src = "/Lego bricks/xiaomi14t.png";
        ...
        document.getElementById("wrong3").addEventListener("click",function(){
            ...
            document.getElementById("submit").onclick=function(){
                ...
                if (A=="hmd skyline"){
                    ...
                    document.getElementById("I").style.display="none"
                    document.getElementById("submit").style.display="none"
                    img.src=("/Lego bricks/congratulations.png")
                }
                else
                    {document.getElementById("intro").innerText= "Wrong. Correct answer was hmd skyline."
                    document.getElementById("rules").innerText="Congratulations! You completed the quiz. Score:"+h+"/4"
